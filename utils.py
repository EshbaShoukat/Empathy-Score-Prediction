...
def preprocess_data(data):
    ...
    cols_to_drop = ['Fixation point X (MCSnorm)', 'Fixation point Y (MCSnorm)',
                    'Event', 'Event value',
...
def feature_extraction(data, group):
    ...
    feature_data.update(pupil_diameter_stats)
    feature_data.update(gaze_point_x_stats)
    feature_data.update(gaze_point_y_stats)
    feature_data.update(fixation_point_x_stats)
    feature_data.update(fixation_point_y_stats)
